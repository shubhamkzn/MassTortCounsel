...
const ServiceOne = () => {
  return (
    <>
      ...
      <section className="hidden sm:flex relative items-center justify-between overflow-hidden bg-gradient-to-r from-[#692D94] to-[#0100AF]
        h-[27.85vh]
        md:h-[301px]
        lg:h-[351px]
        xl:h-[401px]
      ...
      {/* Mobile Hero Section */}
      <section className="bg-[#692D94] flex sm:hidden relative w-full h-[654px] items-start justify-center overflow-hidden">
