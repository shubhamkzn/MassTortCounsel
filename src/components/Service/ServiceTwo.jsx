...
import bag1 from '../../assets/Bag1Purple.png';
import bag2 from '../../assets/Bag2Purple.png';
import bag3 from '../../assets/Bag3Purple.png';
...
const ServiceTwo = () => {
  return (
    <>
      {/* ===== DESKTOP SECTION ===== */}
      <section
        className="hidden md:block bg-[#4F2270] text-white py-12 px-4 sm:px-8 md:px-16"
          ...
          <div className="w-full grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 flex-1">
            {features.map((item, idx) => (
              ...
              >
                ...
                <h3 className="text-lg font-quicksand font-semibold mb-2 text-[#4F2270]">
                  {item.title}
                </h3>
      ...
      {/* ===== MOBILE SECTION ===== */}
      <section
        className="block md:hidden bg-[#4F2270] text-white py-12 px-4"
        style={{ fontFamily: 'Quicksand, sans-serif' }}
      >
